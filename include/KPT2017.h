...
//            bool same_y = CGAL::compare_y(P[w], P[v]) == CGAL::EQUAL;
        ...
        for( size_t i=0; i<3; ++i )
        {
            ...
            {
//                bool same_y = CGAL::compare_y(P[local_anchors[i]], P[w]) == CGAL::EQUAL;
...
//                ++i;
            ...
            Vertex_descriptor v_i = D.source(*i),
                              v_iPlusOne = v_i,
                              v_iLessOne = v_i,
            ...
            for( ; i != boundaryEdgeOnWhiteSide; )
            {
                ...
                else
                {
                    ...
                    auto j_angle = get_angle(P[target], P[v_i], P[j_vertex]),
                         maxAngle = j_angle,
                         minAngle = j_angle;
                    ...
                    {    // j is in a white cone AND all vertices from i+1 to boundaryVertex are on the same side of i,j
                        ...
                        {
                            j_angle = get_angle(P[target], P[v_i], P[j_vertex]);
