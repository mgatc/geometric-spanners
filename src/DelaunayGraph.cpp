...
//
//void DelaunayGraph::add_edge( typename T::Vertex_handle v1, typename T::Vertex_handle v2 ) {
...
//
//    AdjacencyList::iterator v1_incident_vertices = _E.find(v1);
//
...
//    }
//
//    VertexSet eligible_vertices, reserved_vertices, empty_set;
...
// */
//void DelaunayGraph::update_eligible_vertices( VertexHash &eligible, Vertex_handle v, VertexHash &reserved ) {
...
// *  each neighbor.
// */
//void DelaunayGraph::update_incident_chords( Vertex_handle v_update, VertexHash &eligible_vertices, VertexHash &reserved_vertices, int vertices_remaining, bool update_neighbors ) {
//
