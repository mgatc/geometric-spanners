...
GeometricSpannerPrinter::GeometricSpannerPrinter(vector<Point> &P, list<Point> &centersOfPlacedDisks, double radiusOfDisks, string outputFileName) {
    pointSet = P;
...
void GeometricSpannerPrinter::displayPDF() {
