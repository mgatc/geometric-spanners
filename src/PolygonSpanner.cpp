...
//    VertexSet N_PS = _E.find( v_i )->second;     // neighbors of v_1 in PolygonSpanner edges
...
//void PolygonSpanner::find_s_1_in_circulator( Vertex_circulator& C, const VertexSet& N ) {
